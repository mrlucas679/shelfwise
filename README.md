...
flowchart TD
    ...
    subgraph SOURCES["Event Sources"]
        POS["POS / Connectors<br/>SAP · Odoo · SYSPRO · Dynamics · Shopify · Square · Lightspeed · Yoco"]
...
- **Quality:** pytest (743 passing, 15 environment-gated skips) · ruff · GitHub Actions CI · committed capability manifest with drift-failing contract tests
...
tests/                         743 passing tests (15 environment-gated skips): contracts, cascades, security, agentic paths
...
- 743 passing tests (15 environment-gated skips) across contracts, cascades, stores, connectors, MLOps, worldgen, multimodal, and
