...
- **Quality:** pytest (752 passing, 15 environment-gated skips) · ruff · GitHub Actions CI · committed capability manifest with drift-failing contract tests
...
tests/                         752 passing tests (15 environment-gated skips): contracts, cascades, security, agentic paths
...
- 752 passing tests (15 environment-gated skips) across contracts, cascades, stores, connectors, MLOps, worldgen, multimodal, and
